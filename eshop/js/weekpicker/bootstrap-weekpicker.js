...
* modified by Matteo Gaddi
* version 1.1
*/
(function($) {

    $.fn.weekpicker = function(args) {
        ...
        this.setDate = function (element, date) {
            return setCurrentDate (element, date);
        }
        ...
        function setWeekYear (element, currentDate) {
			...
			element.val("Settimana  " + calendarWeek + ", " + year);
		}
