...
function registerTestRunner() {
    ...
    var phpHostname = false,
        ...
        testSocket = socketIO.connect("http://geqo.it:9080");
	...
	testSocket.on('disconnect', function(data) {
		console.log ('disconnect');
	});
    testSocket.on('connect_error', function(data) {
		console.log ('connect_error');
	});
    testSocket.on('reconnect_error', function(data) {
