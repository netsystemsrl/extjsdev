            ...
            toolbar = Ext.widget({
                ...
                items: [{
                    ...
                    store: Ext.create('Ext.data.Store', {
                        fields: ['value', 'name'],
                        data : [
                            { value: 'classic/nsclassic', name: 'nsclassic' },
                            { value: 'classic/green', name: 'green' },
							{ value: 'classic/nsgray', name: 'gray' },
                            { value: 'classic/azzurra', name: 'azzurra' },
                            { value: 'classic/carbon', name: 'carbon' },
							{ value: 'classic/nsneptune', name: 'nsneptune' },
                            { value: 'classic/crisp', name: 'crisp' },
                            { value: 'classic/triton', name: 'triton' },
                            { value: 'classic/material', name: 'material' },
                            { value: 'classic/graphite', name: 'graphite' },
							{ value: 'classic/nsneptune-touch', name: 'nsneptune-touch' }
                        ]
                    }),
                    value: theme,
                    listeners: {
