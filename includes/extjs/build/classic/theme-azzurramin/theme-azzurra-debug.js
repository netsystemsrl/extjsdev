...
Ext.define('ExtThemeCodaxyCore.panel.Panel', {override:'Ext.panel.Panel', initComponent:function() {
  this.callParent();
  var me = this, header = me.header, title = me.getTitle(), tools = me.tools, icon = me.getIcon(), glyph = me.getGlyph(), iconCls = me.getIconCls(), hasIcon = glyph || icon || iconCls, headerPosition = me.getHeaderPosition();
...
Ext.define('Ext.window.WindowActiveCls', {override:'Ext.window.Window', statics:{_activeWindow:null, alwaysOnTop:true}, shadow:false, ghost:false, ui:'blue-window-active', onZIndexChange:function(isTopMost) {
...
Ext.define('Ext.overrides.ToolTip', {override:'Ext.tip.ToolTip', config:{}, shadow:false, ghost:false});
Ext.define('ExtThemeCodaxyCore.tab.Panel', {override:'Ext.tab.Panel', initComponent:function() {
  this.callParent();
