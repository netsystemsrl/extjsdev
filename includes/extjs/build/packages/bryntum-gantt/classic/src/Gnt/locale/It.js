...
Ext.define('Gnt.locale.It', {
    ...
    l10n : {
        ...
        'Gnt.field.ScheduleBackwards' : {
            ...
            'Project finish date' : 'Data fine progetto'
        },
        ...
        'Gnt.constraint.AsLateAsPossible' : {
            name : 'Il più tardi possibile'
        },

        'Gnt.constraint.AsSoonAsPossible' : {
            name : 'Il più presto possibile'
        },
        ...
        "Gnt.panel.ResourceUtilization" : {
            "calculating {0}% done" : "calcolato al {0}% completo"
        }
    },
