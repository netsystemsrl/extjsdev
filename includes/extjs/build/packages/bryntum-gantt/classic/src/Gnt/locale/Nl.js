...
Ext.define('Gnt.locale.Nl', {
    ...
    l10n : {
        ...
        'Gnt.template.TaskTooltip' : {
            ...
            percentText  : 'Gedaan',
            format       : 'd-m-Y',
            overflowText : 'Er {[values.nbrOverflowing > 1 ? "zijn" : "is"]} {nbrOverflowing} meer dan {[values.nbrOverflowing > 1 ? "taken" : "taak"]}'
        },
        ...
        'Gnt.field.ScheduleBackwards' : {
            'Project start date'  : 'Begindatum van het project',
            'Project finish date' : 'Einddatum van het project'
        },
        ...
        "Gnt.panel.ResourceUtilization" : {
            "calculating {0}% done" : "berekend {0}% voltooid"
        }
    },
