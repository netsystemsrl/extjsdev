 ...
 * @version    $Id: XObject.php 1317 2019-01-16 09:55:08Z jan.slabon $
 */
...
abstract class SetaPDF_Core_XObject implements SetaPDF_Core_Resource
{
    ...
    {
        $documentIdent = $this->_indirectObject->getOwnerPdfDocument()->getInstanceIdent();
        $ident = $this->_indirectObject->getObjectIdent();
        $this->_indirectObject = null;
        unset(self::$_xObjects[$documentIdent][$ident]);
    }
