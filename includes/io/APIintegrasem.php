...
// http://iot.integra-fragrances.com/index.php?api=integrasem&mac=08:3A:8D:1A:0F:36&sensors=&settings=eyJGYW5Qb3dlciI6MTAwLCJQdW1wUG93ZXIiOjI1LCJBaXJmbG93UHJvYmUiOjEsInNzaWRuYW1lIjoiIiwicGFzc3dvcmQiOiIiLCJhcG4iOiJ3ZWIub21uaXRlbC5pdCIsInVzZXIiOiIiLCJwYXNzIjoiIiwiZGV2aWNlbmFtZSI6IkZSQUdSQU5DRSBESVNQRU5DRVIiLCJSZWZyZXNoUmF0ZSI6MzB9
	...
	/***************************/
	$doc  = array();
	$doc["TU"] = $srm_impianto['UPDATECYCLE'];		//TIME UPDATE MINUTI DI AGGIORNAMENTO
	...
	$doc["DY"] = $now->format('Y');	//ANNO
	$doc["DM"] = $now->format('m'); //MESE
	$doc["DD"] = $now->format('d'); //GIORNO 
	
	$doc["DN"] = $now->format('w'); //GIORNO DELLA SETTIMANA
	
	$doc["TH"] = $now->format('H');	//ORA
	$doc["TM"] = $now->format('i');	//MINUTI
	$doc["TS"] = $now->format('s');	//SECONDI
