...
define(['underscore', './util', './RelationshipManager'], function (_, util, RelationshipManager) {
    ...
    _.extend(Worksheet.prototype, {
        ...
        */
        ...
        /** added by jsreports */        
        setFitToPageWidth: function(fit) {
            this.fitToPageWidth = !!fit;
        },
        ...
        toXML: function () {
            ...
            if (this.fitToPageWidth) {
                var sheetPr = doc.createElement('sheetPr');
                sheetPr.setAttribute('enableFormatConditionsCalculation', '0');
                var pageSetUpPr = doc.createElement('pageSetUpPr');
            ...
            /** Added by jsreports */
            if (this.fitToPageWidth) {
                //<pageSetup scale="29" fitToHeight="0" orientation="portrait" horizontalDpi="0" verticalDpi="0"/>
                var pageSetup = doc.createElement('pageSetup');
