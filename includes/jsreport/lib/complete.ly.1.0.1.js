 ...
 * 
**/
module.exports = function completely(container, config) {
    config = config || {};
    ...
    txtInput.autocomplete = "false";
    txtInput.name = 'jsr-completion-' + (Math.random() * 100000).toFixed(0);
    ...
    var createDropDownController = function(elem) {
        ...
        var p = {
            ...
            refresh : function(token, array) {
                ...
                ix = 0;
                elem.innerHTML ='';
                var viewportRect = (config.viewport || document.documentElement).getBoundingClientRect();
                // var vph = viewportRect.bottom - viewportRect. || (window.innerHeight || document.documentElement.clientHeight);
                var rect = elem.parentNode.getBoundingClientRect();
                var distanceToTop = rect.top - viewportRect.top;                        // heuristic give 6px 
                var distanceToBottom = viewportRect.bottom - rect.bottom;  // distance from the browser border.
                ...
                // Changed by jsreports: force dropdown to always be below input
                ...
                // } else {
                    elem.style.top = '100%';  
                    elem.style.bottom = '';
                    elem.style.maxHeight =  (distanceToBottom - 10) + 'px';
                // }
