module.exports = function(jsreports, $) {
	jsreports.barcode = {};
	jsreports.barcode.CODE39 = require('./CODE39.js');
	jsreports.barcode.CODE128 = require('./CODE128.js');
	jsreports.barcode.CODE128B = function(string) {
		return new jsreports.barcode.CODE128(string, "B");
	}
	jsreports.barcode.CODE128C = function(string) {
		return new jsreports.barcode.CODE128(string, "C");
	};
	jsreports.barcode.EAN = require('./EAN_UPC.js');
	jsreports.barcode.UPC = function(UPCnumber){
		this.ean = new jsreports.barcode.EAN("0"+UPCnumber);
		this.valid = function(){
	...
	jsreports.barcode.pharmacode = require('./pharmacode.js');
	jsreports.barcode.ITF = require('./ITF.js');
	jsreports.barcode.ITF14 = require('./ITF14.js');
	...
	var JsBarcode = function(image, content, options, validFunction) {
		...
		var encoder = new jsreports.barcode[options.format](content);
