 ...
 * @version    $Id: SecHandler.php 1102 2017-09-13 06:31:07Z jan.slabon $
 */
...
abstract class SetaPDF_Core_SecHandler
{
    ...
    {
        if (strlen($data) < 32) {
            throw new InvalidArgumentException('Cannot decrypt string with a length lower than 32 bytes.');
        }
