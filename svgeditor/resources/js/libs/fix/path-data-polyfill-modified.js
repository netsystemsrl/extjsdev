...
if (!SVGPathElement.prototype.getPathData || !SVGPathElement.prototype.setPathData) {
  (function() {
    ...
    var absolutizePathData = function(pathData) {
      ...
      pathData.forEach( function(seg) {
        ...
        if (type === "M") {
          ...
          absolutizedPathData.push({type: "L", values: [x, currentY]});
          currentX = x;
        }
        ...
        // }
          ...
          var y = seg.values[0];
          //absolutizedPathData.push({type: "V", values: [y]});
          absolutizedPathData.push({type: "L", values: [currentX, y]});
          currentY = y;
        }
    ...
    //   var pathData = parsePathDataString(this.getAttribute("d") || "");
    //
    //   if(!options) options = {normalize:true}; // per default è true;
    //
    //   if (options && options.normalize) {
    ...
    SVGPathElement.prototype.getPathData = function( options )
    {
      ...
      if(options.absolutize) pathData = absolutizePathData(pathData);
      if(options.normalize) pathData = reducePathData(pathData);
      return pathData;
    };
